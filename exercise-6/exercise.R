...
max.prop2013 <- max(prop.2013)
popular.2013 <- names.2013[prop.2013 == max.prop2013]
...
MostPopular <- function(my.year) {
  ...
  max.prop.year <- max(prop.year)
  popular.name <- names.year[prop.year == max.prop.year]
  return (paste(popular.name, "was the most popular name in", my.year)) 
}

# What was the most popular female name in 1994?
popular.1994 <- MostPopular(1994)
